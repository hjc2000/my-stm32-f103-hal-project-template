...
void hal::ConfigClockSignal()
{
    ...
    clock_init_options._clock_type = hal::ClockSignalConfig::ClockType::SYSCLK | hal::ClockSignalConfig::ClockType::HCLK | hal::ClockSignalConfig::ClockType::PCLK1 | hal::ClockSignalConfig::ClockType::PCLK2;
