...
BaseTimerInitOptions &hal::BaseTimerInitOptions::operator=(TIM_Base_InitTypeDef const &o)
{
	...
	_period = o.Period;
	_is_auto_reload_preload_enabled = static_cast<AutoReloadPreload>(o.AutoReloadPreload);
	return *this;
}
...
hal::BaseTimerInitOptions::operator TIM_Base_InitTypeDef() const
{
	...
	o.Period = _period;
	o.AutoReloadPreload = static_cast<uint32_t>(_is_auto_reload_preload_enabled);
	return o;
}
